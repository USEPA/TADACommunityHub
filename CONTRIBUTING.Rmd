...
## About TADA Community Hub

-   This package will act as a repository for TADA users who have filled
    out the TADA criteria and methods table for parameters and uses of
    waters that align with the necessary TADA format.
    
-   The purpose of this package repository is to assist TADA users in 
    evaluating and visualizing Water Quality Portal (WQP) data more 
    efficiently by specifying the water quality standards that are 
    applicable for analysis. This public repository will allow other states
    and tribes to find commonalities in assessment processes across the
    nation.
    
-   This repository will allow TADA users to store and reuse the criteria
    and methodology table and will help to avoid duplicate efforts in the
    future and help to streamline analysis of Water Quality Portal (WQP)  
    data.
